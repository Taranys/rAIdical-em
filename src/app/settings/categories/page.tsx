  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <h1 className="text-4xl font-bold tracking-tight mb-8">Review Categories</h1>
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-4xl font-bold tracking-tight">Review Categories</h1>
          <p className="text-muted-foreground mt-1">
            Define the review categories used by the LLM to classify review comments.
          </p>
        </div>
      </div>
