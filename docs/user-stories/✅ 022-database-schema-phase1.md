...
- [x] Drizzle ORM schema defines the following tables:
...
- [x] Migrations are generated via `npm run db:generate` and applied via `npm run db:migrate`
- [x] Foreign keys and indexes are defined for common query patterns
