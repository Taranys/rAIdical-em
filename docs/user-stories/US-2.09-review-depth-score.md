...
- [US-2.05: Batch Classify Comments](US-2.05-batch-classify-comments.md) — classified comments needed for scoring
- [US-2.03: Phase 2 Database Schema](US-2.03-phase2-database-schema.md) — seniority profiles table
