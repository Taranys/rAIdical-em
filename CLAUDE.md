...
- Plans reference user stories via relative links — never duplicate user story content in a plan. Example: `[US-005: Configure GitHub PAT](../user-stories/005-configure-github-pat.md)`.
